...
function callGeminiApi($message) {
    ...
    try {
        ...
        //option1: use generateContent to return GenerateContentResponse
...
/*         //option2: Use streamGenerateContent to process the input data with the proper request object
