        ...
        <div class="row">
            <div class="col-md-12 columns">
                ...
                <div id="scrollContent">
                    ...
                    <p>
                        Currently, PII and identifiable clinical data is not permitted in OD Chat. Please us de-identified and anonymized data. We are actively working with HHS security to enable this use-case.
                    </p>
                    <p>
                        Please note that these use cases are specific to OD Chat, which is different than public AI tooling like ChatGPT, Meta.AI, and Google Gemini. When using any public AI tooling, please follow OCIO Guidance, which prohibits these sensitive workloads. Unlike the public tooling, data entered into OD Chat is not shared with Microsoft or OpenAI. This enables the sensitive workloads described above.
                    </p>
                    <p>When using OD Chat, you must abide by these following guidelines:</p>
                    <ol type="1">
                        <li>
                            <b>Human Oversight:</b> Always review and validate outputs generated by OD Chat. Do not base decision-making or policymaking solely on generated outputs. Do not include any patient identifiable information with genomic data.
                        </li>
                        <li>
                            <b>Limitations and Biases:</b> AI models are only as powerful as its training data. Generative AI may generate biased results and may not always generate accurate responses. Generative AI may perform poorly in certain applications. Always validate outputs generated by OD Chat.
                        </li>
                        <li>
                        ...
                        <li> 
                            <b>No PII:</b> PII and identifiable clinical data is currently not permitted in OD Chat. Only use de-identified and anonymized data. This includes but not limited to genomic data, passport information, social security numbers, driver's license numbers, Military status, bank account information, photographic identifiers, & date of birth.
                        </li>
                        <li> 
                            <b>Training Data:</b> OD Chat uses commercial models. It is not fine-tuned on NIH, OD, or biomedical topics. Do not expect OD Chat to have any internal knowledge of the NIH or OD.
                        </li>
                    </ol>
                    <p>
