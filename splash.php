        ...
        <div class="row">
            ...
            <div class="col-md-8 columns">
                ...
                <div style="height: 55vh; overflow-y:auto; overflow-x:hidden;">
                    ...
                    <p>When using OD Chat, please follow these guidelines:</p>
                    <ol type="1">
                        <li>
                            <b>Human Oversight:</b> Always review and validate outputs generated by OD Chat. Do not base decision-making or policymaking solely on generated outputs.
                        </li>
                        <li>
                        ...
                        <li> 
                            <b>No PII:</b> PII and identifiable clinical data is currently not permitted in OD Chat. Only use de-identified and anonymized data.
                        </li>
                        <li> 
